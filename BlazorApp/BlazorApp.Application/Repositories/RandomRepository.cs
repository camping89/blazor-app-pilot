...
public class RandomRepository : IRandomRepository
{
    ...
    public RandomRepository(IEmployeeRepository employeeRepository, IClientRepository clientRepository, IShiftRepository shiftRepository, IDeviationRepository deviationRepository)
    {
